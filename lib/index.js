...
function Strategy(options, verify) {
  ...
  this.options = xtend({}, options, {
    authorizationURL: 'https://' + options.auth0_domain + '/authorize',
    tokenURL:         'https://' + options.auth0_domain + '/oauth/token',
    userInfoURL:      'https://' + options.auth0_domain + '/userinfo',
    apiUrl:           'https://' + options.auth0_domain + '/api'
  });
